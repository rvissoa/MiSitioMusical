...
public class FragmentoTabAgregarCancion extends Fragment{
    @Override
    public View onCreateView(LayoutInflater inflater,
            ViewGroup container, Bundle savedInstanceState) {
    	View vistaBusqueda=inflater.inflate(R.layout.fragment_tab_agregar, container, false);
    	Spinner spinnerAlbumes = (Spinner) vistaBusqueda.findViewById(R.id.spinnerAlbumesAgrega);
    	...
    	Spinner spinnerGeneros = (Spinner) vistaBusqueda.findViewById(R.id.spinnerGeneroMusica);
    	// Create an ArrayAdapter using the string array and a default spinner layout
    	//this.getActivity.getApplicationContext obtiene el contexto de otro sitio
